...
public class SimulationRepository : ISimulationRepository
{
    ...
    public void Add(int numberOfSteps, int amountOfResources, ExplorationOutcome? outcome)
    {
        ...
        var query =
            $"INSERT INTO simulations (time_of_the_simulation, number_of_steps, amount_of_resources_found, outcome) VALUES ('{currentTime}','{numberOfSteps}','{amountOfResources}','{outcome.ToString()}')";
