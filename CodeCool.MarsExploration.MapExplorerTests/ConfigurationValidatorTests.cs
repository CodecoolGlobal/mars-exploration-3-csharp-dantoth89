...
public class ConfigurationValidatorTests
{
    ...
    {
        var configurationModel = new ConfigurationModel(filePath, new Coordinate(1, 1), new[] { "#", "&" }, 10);
    ...
    {
        var configurationModel = new ConfigurationModel("filePath", landingSpot, new[] { "#", "&" }, 10);
    ...
    {
        var configurationModel = new ConfigurationModel("filePath", new Coordinate(1, 1), resourcesToLookFor, 10);
        var map = new Map(_mapRepresentation);
        var isValid = _configurationValidator.Validate(configurationModel, map);
    ...
    {
        var configurationModel = new ConfigurationModel("filePath", new Coordinate(1, 1), new[] { "#", "&" }, timeoutSteps);
        var map = new Map(_mapRepresentation);
        var isValid = _configurationValidator.Validate(configurationModel, map);
